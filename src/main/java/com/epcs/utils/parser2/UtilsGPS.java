...
public class UtilsGPS {
	public static double split2full(int degree, int minute, int second) {
		return (degree + ((double) minute) / 60 + ((double) second) / 3600);
	}

	public static int[] full2split(double d) {

		int[] split = new int[3];
		// 121.547502,31.197516

		int degree = (int) d;
		int minute = (int) ((d - degree) * 60);
		int second = (int) (((d - degree) * 60 - minute) * 60);
